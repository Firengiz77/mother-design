...
<link rel="stylesheet" href="{{ asset('/admin/assets/css/choise.css')}}">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> {{ __('Permissions') }} </h4>
              ...
              <div class="row mb-5">
                <div class="col-md-4 col-lg-2 mb-3 card-body" style="border:1px solid #a1acb8;border-radius:8px">
                  ...
                  @endif
                    ...
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.permissions.update',$permission->id) }}">
                        @csrf
