              ...
              <div class="row mb-5">
                <div class="col-md-4 col-lg-2 mb-3 card-body" style="border:1px solid #a1acb8;border-radius:8px">
                  ...
                  @endif
                    ...
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.roles.update',$role->id) }}">
                        @csrf
                      ...
                      <input class="form-check-input" @checked(in_array($permission->name, $rolePermissions))
