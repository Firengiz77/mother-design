...
<link rel="stylesheet" href="{{ asset('/admin/assets/css/choise.css')}}">
  ...
  <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ __('Admin') }} /</span> {{ __('Innovations') }}</h4>
      ...
      <div class="row">
        ...
        <div class="alert alert-danger" role="alert" > {{$error}} </div>
          ...
          <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('admin.innovation.store') }}">
            @csrf
