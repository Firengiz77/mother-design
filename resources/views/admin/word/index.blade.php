...
@section('container')
          ...
          <div class="content-wrapper">
            ...
            <div style="display: flex;align-items: baseline;flex-direction: row;justify-content: space-between;">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ __('Admin') }} /</span> {{ __('Word') }} </h4>
             
              @can('word-create')
              <a class="btn btn-success" href="{{ route('admin.word.create') }}">{{ __('Word') }}   {{__('Create')}}  </a>
              @endcan
          </div>
              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">{{ __('Word') }} </h5>
